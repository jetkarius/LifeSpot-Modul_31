...
namespace LifeSpot
{
    public static class EndpointMapper
    {
        ...
        {
            var imgFiles = new[] { "london.jpg", "ny.jpg", "spb.jpg", "london2.jpg", "ny2.jpg", "spb2.jpg" };

            foreach (var fileName in imgFiles)
            {
                builder.MapGet($"/Views/Shared/Image/{fileName}", async context =>
                {
                    var imgPath = Path.Combine(Directory.GetCurrentDirectory(), "Views", "Shared", "Image", fileName);
